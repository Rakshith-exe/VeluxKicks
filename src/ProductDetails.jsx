            ...
            <div>
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-4 rounded-lg font-bold text-lg hover:shadow-lg transition flex items-center justify-center gap-2"
                >
                  <CreditCard size={24} />
                  Buy Now
                </button>
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-teal-600 text-white py-4 rounded-lg font-bold text-lg hover:shadow-lg transition flex items-center justify-center gap-2"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg text-center">
                  <p className="text-gray-600 text-sm font-semibold">FREE SHIPPING</p>
                  <p className="text-gray-500 text-xs">On all orders above ₹500</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg text-center">
                  <p className="text-gray-600 text-sm font-semibold">15 DAYS RETURN</p>
                  <p className="text-gray-500 text-xs">Easy returns & exchanges</p>
                </div>
              </div>
            </div>
          </div>
