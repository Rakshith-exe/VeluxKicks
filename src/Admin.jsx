...
import {
  ...
  Eye, X, Home, BarChart3, TrendingUp, Lock, Mail, LogOut
} from "lucide-react";
            ...
            <form onSubmit={handleSaveProduct} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500"
                  placeholder="/images/SHOE1.jpg"
                />
                <p className="text-xs text-gray-500 mt-1">Enter path like /images/SHOE1.jpg or full URL</p>
              </div>
