      ...
      <div className="px-4 md:px-6 py-3 flex justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-2 md:gap-3">
              <button
                ...
                className="flex items-center gap-2 text-white hover:text-teal-200 transition"
              >
                <User size={20} />
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 bg-gradient-to-r from-blue-700 to-teal-600 px-4 py-2 rounded-lg hover:shadow-lg transition font-semibold"
            >
              <User size={20} />
              <span>Login</span>
            </button>
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center p-2 rounded-lg hover:bg-slate-700 transition"
          >
